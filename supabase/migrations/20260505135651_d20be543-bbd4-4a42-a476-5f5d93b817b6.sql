CREATE OR REPLACE FUNCTION public.get_dashboard_stats(_mes integer DEFAULT NULL::integer, _ano integer DEFAULT NULL::integer, _data_inicio date DEFAULT NULL, _data_fim date DEFAULT NULL)
 RETURNS jsonb
 LANGUAGE plpgsql
