  ...
  const handleSave = async () => {
    ...
    try {
      const { data: rel, error } = await supabase.from("relatorios_atividade").insert({
        ...
        educador_apoio_id: form.educador_apoio_id || null,
      ...
      // NOTA: Auto-transferência de período via relatório foi removida em 17/04/2026.
      // Causava dessincronização de vínculos turma_participantes (alunos sumindo da chamada).
      // Mudanças de período devem ser feitas explicitamente pelo perfil do participante.
